...
/**
 * Ref: https://leetcode.com/problems/find-the-winner-of-the-circular-game/
 *
...
//        int res = findWinnerOfCircularGame.findTheWinner(n, k);
        int res = findWinnerOfCircularGame.findTheWinnerV2(n, k);
        System.out.println("Result: " + res);
    }

    /**
     * Using Circular Linked List to simulate the steps
     *
     * @param n
     * @param k
     * @return
